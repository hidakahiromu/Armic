...
<body>
  ...
  <div class="Mypage_background">
    <!--<div class="Mypage_box1">
      ...
      <div class="Mypage_Allbox"><!--このクラスは今のところ使わねえ-->
          <div class=Mypage_NameIcon_box>

			<?php $username ='aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';?><!--$usernameにusernameを入れる-->

            <div class="Mypage_NameBox">
				<p><?php echo $username;?></p>
				<p>さんようこそ</p>
				<!--マイページ編集画面移動-->
				<div class=Mypage_config><a href="MyPageConfig.php"><button class="Mypage_Config_button" type="button" style="width:100%;height:100%"><p>アーティスト名の取得</p></button></a></div>
			</div>
              ...
               
				...
				<div class='Mypage_MusicBox'><a href="Mypage_Music.php"><button class="Mypage_button" type="button" style="width:100%;height:100%"><p>音楽を投稿したい方はこちら</p></button></a></div>
							...
							<table class='Mypage_Posted_MusicBox_Table'>
								...
								<tr>
									...
									<td class='Mypage_Posted_MusicBox_TableDelete'>
										<div class='Mypage_MusicBox_Delete'><a href="Mypage_Music.php"><button class="Mypage_Delete_button" type="button" style="width:100%;height:100%"><p>delete</p></button></a></div>
									</td>
								</tr>
